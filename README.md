...
| ![Operating systems]([https://i.imgur.com/harHKcH.png](https://imgur.com/a/axxQWDp))              	|           Mostly focused on the IT thing with windows and all linux distributions. I do also know my way around macos in a "IT" kind of a way. Ask me anything about linux or any other operating systems and ill be happy to answer. In other words yeah I've done my homework regarding IT with different operating systems.                                                                                                                                                                                                    	|
| Operation systems | [](https://en.wikipedia.org/wiki/Operating_system)), [Linux](https://fi.wikipedia.org/wiki/Linux)), [Windows](https://fi.wikipedia.org/wiki/Microsoft_Windows) & [MacOs](https://en.wikipedia.org/wiki/DirectX](https://en.wikipedia.org/wiki/Operating_system](https://fi.wikipedia.org/wiki/MacOS)https://fi.wikipedia.org/wiki/MacOS))
